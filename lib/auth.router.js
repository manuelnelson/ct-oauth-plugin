...
module.exports = (plugin, connection, generalConfig) => {
    ...
    const API = (function api() {
        ...
        async function getUnconfirmedUsers(ctx) {
            debug('Get Unconfirmed Users');
            ctx.body = await AuthService.getUnconfirmedUsers();
        }
    ...
    ApiRouter.get('/user/unconfirmed', isLogged, isAdmin, API.getUnconfirmedUsers);
